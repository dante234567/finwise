...
export default function Negocio() {
  const { movimientos, presupuestos, perfil, getTotalesMes, getDistribucionGanancias, fetchBreakeven, breakeven, addPresupuesto, updatePresupuesto, deletePresupuesto } = useStore()
